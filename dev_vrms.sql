...
--
-- Host: localhost
-- Generation Time: May 27, 2022 at 05:12 AM
...
CREATE TABLE `vehicles` (
  ...
  `certify_doc_number` varchar(50) DEFAULT NULL,
  `certify_doc_remark` varchar(255) DEFAULT NULL,
...
CREATE TABLE `vehicles_pre_upload` (
  ...
  `certify_doc_remark_t` varchar(25) DEFAULT NULL,
...
--
ALTER TABLE `license_no_history`
  MODIFY `lice_no_his_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `license_no_history_detail`
--
ALTER TABLE `license_no_history_detail`
  MODIFY `license_status_det_id` int(11) NOT NULL AUTO_INCREMENT;
